...
class InputPasswordSimple extends StatefulWidget {
  ...
  @override
  State<InputPasswordSimple> createState() => _InputPasswordSimpleState();
}

class _InputPasswordSimpleState extends State<InputPasswordSimple> {
  ...
  static List<PasswordRequirement> get _defaultRequirements => 
      PasswordRequirements.sinmpleRequirements;
