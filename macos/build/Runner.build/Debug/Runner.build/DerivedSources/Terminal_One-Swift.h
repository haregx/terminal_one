...
#ifndef TERMINAL_ONE_SWIFT_H
#define TERMINAL_ONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Terminal_One",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12Terminal_One11AppDelegate")
...
SWIFT_CLASS("_TtC12Terminal_One17MainFlutterWindow")
